...
var token = fs.readFileSync('./generate-changelog-token.local.txt', "utf-8").trim();


console.log('\n =========== To do the release run following commands  ==========================');
console.log(' git commit -m "docs(CHANGELOG): ' + npmVersion + '"');
console.log(' git tag v' + npmVersion );
console.log(' git push --follow-tags');
console.log(' git push origin --tags');
console.log(' npm run build.release');
console.log(' npm run publish');
console.log(' ng build --base-href' +
  ' "https://github.wdf.sap.corp/pages/core-ui-platform/AribaCoreUI/" ');
console.log(' ngh --no-silent');
