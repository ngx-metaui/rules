...
xdescribe('Interceptor: Mock-Server', () => {
    ...
    // xit('should find and retrieve specific user objects by query ',
    //     inject([HttpClient, Resource],
    //         (http: HttpClient, service: Resource) => {
    //
    ...
    it('can save new user by posting new object and getting object with Id and 201 response ',
        inject([HttpClient, Resource],
            (http: HttpClient, service: Resource) => {
    ...
    it('can save existing user by PUTing it and getting object with Id and 200 response ',
        inject([HttpClient, Resource],
            (http: HttpClient, service: Resource) => {
            ...
            (http: HttpClient, service: Resource) => {
                ...
                service.load()
                    ...
                    .asHttpResponse<UserTest>(() => {
                        ...
                        expect(error.error.msg).toBe('Record not found');
                    });
            }));
});
