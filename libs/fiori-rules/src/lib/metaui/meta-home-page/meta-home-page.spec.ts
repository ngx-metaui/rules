...
import {FioriRulesModule} from '../../fiori-rules.module';
...
describe('How we can retrieve homepage from module', () => {
 ...
 `;
  ...
  it('should retrieve application based module and its homePage TestMetaHomePage',
    ...
    expect(homePage).toEqual('HomeCustom');
    ...
    context.pop();
    expect(homePage).toEqual('ProductCustom');
