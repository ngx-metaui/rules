...
describe(' Input field', () => {
    ...
    describe(' instantiation of the InputFieldComponent so it have correct values under ' +
        ...
        it('It should setup a default values when just a value bindings is passed.', () => {
            ...
            expect(fixtureWrapper.componentInstance.inputComponent.env.currentForm).toBeDefined();
            expect(fixtureWrapper.componentInstance.inputComponent.formControl).toBeDefined();
            expect(fixtureWrapper.componentInstance.inputComponent.name).toBeDefined();
        });


        it('it should be instantiated with correct input value that we pass in which is ' +
            '=> Some text', () => {

            let fixtureWrapper = TestBed.createComponent(TestInputInstantiationComponent);
            fixtureWrapper.detectChanges();

            expect(fixtureWrapper.componentInstance.inputComponent.value).toEqual('Some text');
        ...
        it('It should have default input field type text when we pass string or text. or number ' +
            'of we pass number as binding', () => {
    ...
    describe('describe how it inherits values from FormContainer and FormRowComponents', () => {
        ...
        it('It should corectly display a label that comes from parent as well as has placeHolder',
            () => {
                let fixtureWrapper = TestBed.createComponent(TestInputWithImplicitValuesComponent);
                fixtureWrapper.detectChanges();
                ...
                let formInput = fixtureWrapper.debugElement.query(By.css('.ui-g-12 > label'));
                expect(formInput.nativeElement.textContent).toEqual('My Name');
            });


        it('It should inherit and render the required flag just next the the label and field', () => {
            let fixtureWrapper = TestBed.createComponent(TestInputWithImplicitValuesComponent);
            fixtureWrapper.detectChanges();

            expect(fixtureWrapper.componentInstance.inputComponent.placeHolder).toEqual('My Name');
    ...
    describe('Describe how input field behaves inside FormRow - this focuses mainly on size', () => {
