...
} from '../../../src/widgets/wizard-progress/wizard-progress.component';
...
describe('WizardProgressComponent', () =>
{
    ...
    it('should show the steps', () =>
    {
        ...
        let steps = fixture.debugElement
    ...
    it('should show current step/total steps', () =>
    {
        ...
        let stepIndicator = fixture.debugElement.query(By.css('div.step-indicator'));
