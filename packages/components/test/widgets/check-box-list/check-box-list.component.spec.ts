...
import {CheckBoxListComponent} from '../../../src/widgets/check-box-list/check-box-list.component';
import {AWCheckBoxListModule} from '../../../src/widgets/check-box-list/check-box-list.module';
