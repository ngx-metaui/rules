...
var Datatable2Component = /** @class */ (function (_super) {
    ...
    function (cell, column, item) {
        ...
        if (isPresent(this.state.selection) && this.state.selection.length > 0) {
            /** @type {?} */
            var foundIndex_1 = ListWrapper.findIndexComplex(this.state.selection, lookupKey);
            /** @type {?} */
    ...
    function (event, item) {
        ...
        if (isPresent(this.state.selection) && this.state.selection.length > 0) {
            /** @type {?} */
            var foundIndex_2 = ListWrapper.findIndexComplex(this.state.selection, item);
            /** @type {?} */
        ...
        if (childrenForNode.length > 0) {
            ...
            if (!isSelected) {
                ...
                var _loop_1 = function (child) {
                    /** @type {?} */
                    var foundIndex = ListWrapper.findIndexComplex(this_1.state.selection, child);
    ...
    function (currentItem, isSelected) {
        ...
        if (isPresent(parent)) {
            ...
            if (!isSelected) {
                ...
                if (!allSelected) {
                    /** @type {?} */
                    var parentIndex_1 = ListWrapper.findIndexComplex(this.state.selection, parent);
                    this.state.selection = this.state.selection
